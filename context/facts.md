...
| Backlog figure | `Cleared a backlog of a few hundred billing packages` — own account (CS, F) | B: "unblocked recovery … volume itself unverified"; SN: size "lost, to recover from PO or program records" | CONFLICT || 2026-09-11: a few hundred projects, completed. Unit changed from billing packages to projects |
