...
export default function ConfidenceThresholds() {
  return (
    <DiagramPanel
      ...
      subheading="I defined the three-tier model — act automatically, recommend and wait, stop and escalate — as the product boundary the platform enforces. The model-confidence cut-offs that place a given action in a tier are still to be set with ML engineering as the pilot produces confidence data; they are a separate question from the signal thresholds we set with domain experts."
